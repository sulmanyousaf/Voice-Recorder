...
class NotificationHelper(private val context: Context) {
    ...
    private fun createChannels() {
        ...
        val pinnedChannel = NotificationChannel(
            CHANNEL_PINNED,
            context.getString(R.string.channel_active_name),
            NotificationManager.IMPORTANCE_LOW
        ).apply {
            description = context.getString(R.string.channel_active_desc)
            setShowBadge(false)
        }
    ...
    private fun scheduleAlarm(alarmManager: AlarmManager, hour: Int, minute: Int, requestCode: Int) {
        val intent = Intent(context, NotificationReceiver::class.java).apply {
            action = "voicerecorder.applico.voice.recorder.ACTION_SHOW_REMINDER"
