...
// Custom Semantic Colors (Brand Enforced)
val color_light_recording = Color(0xFFD32F2F) // Deep Studio Red
val color_dark_recording = Color(0xFFEF5350)

val color_light_waveform = Color(0xFF1976D2) // Vibrant Blue
val color_dark_waveform = Color(0xFF42A5F5)

val color_light_warning = Color(0xFFF57C00) // Distinct Orange
val color_dark_warning = Color(0xFFFFB74D)
